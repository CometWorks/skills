...
This document provides more detailed command execution guidance for the `se-dev-torch` skill.
...
3. Set `TORCH_ROOT` when you want to use an existing local Torch checkout
