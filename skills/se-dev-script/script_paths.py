...
All persistent script data lives under the Data junction inside the skill folder.
The junction is created by Prepare.bat and points at %USERPROFILE%\\.se-dev\\script.

Steam workshop content is read directly from its Steam folder rather than
symlinked into the skill, so unrelated workshop items (mods, blueprints,
scenarios) stay out of the way.
"""
...
SCRIPT_LIST_FILE = DATA_DIR / "scripts.json"
SCRIPT_HASHES_FILE = DATA_DIR / "script_hashes.json"
