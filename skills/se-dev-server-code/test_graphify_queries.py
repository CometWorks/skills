...
QUERIES = [
    ...
    ("query", ["query", "How does the dedicated server start a session?", "--budget", "400"]),
    ("query", ["query", "How does the server handle multiplayer clients?", "--budget", "400"]),
