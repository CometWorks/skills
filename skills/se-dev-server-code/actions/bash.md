...
Rest of this page covers Windows specifics. On Linux only rules 2 and 3 below
apply, and neither BusyBox nor PowerShell are involved.
...
If busybox doesn't work for a task, use PowerShell instead:
...
BusyBox provides many standard UNIX utilities:
