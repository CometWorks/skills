...
:: folder. The Data folder (a junction to %USERPROFILE%\.se-dev-skills\
:: se-dev-server-code) is preserved: only the junction itself is removed so the
...
:: Remove the Bin64 junction (also leaves the actual server install untouched).
if exist Bin64 rmdir Bin64
