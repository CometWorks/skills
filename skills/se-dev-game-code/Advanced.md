...
uv run search_game_code.py -l 10 class usage MyEntity           # First 10
uv run search_game_code.py -l 10 -o 100 class usage MyEntity    # Mid-range sample
uv run search_game_code.py -l 10 -o 1200 class usage MyEntity   # End sample
```
...
```bash
# Start broad
uv run search_game_code.py -c -n Sandbox class declaration ""
# Output: 3421
...
# Now fetch results
uv run search_game_code.py -l 20 -n Sandbox.Game.Entities class declaration ""
```
...
uv run search_game_code.py -n VRageMath class declaration ""

# 2. Pick interesting class, find its methods
uv run search_game_code.py -n VRageMath method declaration "" | grep Vector3D
...
# 3. Find usages
uv run search_game_code.py -l 20 class usage MyTerminalBlock

# 4. Find related methods
uv run search_game_code.py -n Sandbox.Game method declaration Terminal
```
...
```bash
# 1. Find base class
uv run search_game_code.py class parent MyFunctionalBlock

# 2. Find siblings
uv run search_game_code.py class children MyTerminalBlock

# 3. Find what they all implement
uv run search_game_code.py class implements "re:^My.*Block$"
```
...
uv run search_game_code.py -n VRageMath method signature ""
...
uv run search_game_code.py -n VRageMath method declaration ""

# Game entities (Sandbox.Game)
uv run search_game_code.py -n Sandbox.Game.Entities class declaration ""

# Object builders (SpaceEngineers.ObjectBuilders)
uv run search_game_code.py -n SpaceEngineers.ObjectBuilders class declaration ""

# Core utilities (VRage.Library)
uv run search_game_code.py -n VRage class declaration ""
```
...
```bash
uv run search_game_code.py -l 10 -o 0 class usage MyEntity      # Window 1
uv run search_game_code.py -l 10 -o 200 class usage MyEntity    # Window 2
uv run search_game_code.py -l 10 -o 400 class usage MyEntity    # Window 3
uv run search_game_code.py -l 10 -o 600 class usage MyEntity    # Window 4
```
...
uv run search_game_code.py -n Sandbox.Game class usage MyEntity
uv run search_game_code.py -n VRage class usage MyEntity
uv run search_game_code.py -n SpaceEngineers class usage MyEntity
```
