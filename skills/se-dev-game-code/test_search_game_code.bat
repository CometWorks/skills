...
uv run search_game_code.py class declaration MyProjectorBase
echo.
...
uv run search_game_code.py -l 5 class usage MyPhysicsBody
echo.
echo --- MyProjectorBase class usage (limit 5) ---
uv run search_game_code.py -l 5 class usage MyProjectorBase
echo.
...
uv run search_game_code.py struct declaration "re:^Color$"
echo.
...
uv run search_game_code.py -l 5 struct usage "re:^Color$"
echo.
...
uv run search_game_code.py -l 5 method declaration Activate
echo.
echo --- Build method declaration (limit 5) ---
uv run search_game_code.py -l 5 method declaration "re:^Build$"
echo.
echo --- Abs method in Vector3D (namespace filter) ---
uv run search_game_code.py -n VRageMath method declaration "re:^Abs$"
echo.
...
uv run search_game_code.py -l 5 method usage Activate
echo.
echo --- ClampToByte method usage (limit 5) ---
uv run search_game_code.py -l 5 method usage ClampToByte
echo.
...
uv run search_game_code.py field declaration AllowScaling
echo.
...
uv run search_game_code.py -l 5 field usage "re:^Forward$"
echo.
echo --- AngularDamping field usage (limit 5) ---
uv run search_game_code.py -l 5 field usage AngularDamping
echo.
...
uv run search_game_code.py interface declaration IMyPhysics
echo.
echo --- IPhysicsMesh interface declaration ---
uv run search_game_code.py interface declaration IPhysicsMesh
echo.
...
uv run search_game_code.py -l 5 interface usage IMyEntity
echo.
...
uv run search_game_code.py enum declaration MyPhysicsOption
echo.
echo --- GridEffectType enum declaration ---
uv run search_game_code.py enum declaration GridEffectType
echo.
...
uv run search_game_code.py -l 5 enum usage MyPhysicsOption
echo.
...
uv run search_game_code.py -n Sandbox.Engine.Physics -l 5 class declaration ""
echo.
echo --- Methods in VRageMath namespace containing "Add" ---
uv run search_game_code.py -n VRageMath -l 5 method declaration Add
echo.
...
uv run search_game_code.py -l 3 struct usage Vector3D
echo.
echo --- Next 3 Vector3D usages (offset 3) ---
uv run search_game_code.py -l 3 -o 3 struct usage Vector3D
echo.
echo --- Skip 6, show 3 ---
uv run search_game_code.py -l 3 -o 6 struct usage Vector3D
echo.
...
uv run search_game_code.py -c method declaration Activate
echo.
...
uv run search_game_code.py -l 5 class declaration "re:^MyPhysics"
echo.
...
uv run search_game_code.py -l 5 method signature Activate
echo.
echo --- Build method signature (limit 5) ---
uv run search_game_code.py -l 5 method signature "re:^Build$"
echo.
echo --- Abs method signature in VRageMath namespace ---
uv run search_game_code.py -n VRageMath method signature "re:^Abs$"
echo.
...
uv run search_game_code.py class parent MyProjectorBase
echo.
...
uv run search_game_code.py -l 5 class children MyEntity
echo.
echo --- Find children of MyTerminalBlock (limit 3) ---
uv run search_game_code.py -l 3 class children MyTerminalBlock
echo.
...
uv run search_game_code.py interface parent IMyTerminalBlock
echo.
echo --- Find parent of IMyFunctionalBlock ---
uv run search_game_code.py interface parent IMyFunctionalBlock
echo.
...
uv run search_game_code.py -l 5 interface children IMyEntity
echo.
echo --- Find children of IMyCubeBlock (limit 3) ---
uv run search_game_code.py -l 3 interface children IMyCubeBlock
echo.
...
uv run search_game_code.py class implements MyGrid
echo.
...
uv run search_game_code.py -l 5 interface implementors IMyEntity
echo.
echo --- Find implementors of IMyTerminalBlock (limit 5) ---
uv run search_game_code.py -l 5 interface implementors IMyTerminalBlock
echo.
...
uv run search_game_code.py -c class children MyEntity
echo.
echo --- Count implementors of IMyEntity ---
uv run search_game_code.py -c interface implementors IMyEntity
echo.
...
uv run search_game_code.py -n Sandbox.Game -l 5 class children MyEntity
echo.
echo --- Find implementors of IMyEntity in VRage.Game.ModAPI namespace ---
uv run search_game_code.py -n VRage.Game.ModAPI -l 3 interface implementors IMyEntity
echo.
