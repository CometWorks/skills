...
- Subsequent runs detect game updates automatically: if game's version changes, previous `Decompiled/` (including the copied `Content/`) and `CodeIndex/` directories wiped and rebuilt; previous version stays available in Git history.
